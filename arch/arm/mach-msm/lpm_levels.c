...
static struct of_device_id cpu_modes_mtch_tbl[] initdata = {
...
static struct of_device_id system_modes_mtch_tbl[] initdata = {
...
static struct of_device_id lpm_levels_match_table[] initdata = {
